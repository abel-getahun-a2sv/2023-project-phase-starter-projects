        ...
        <div className={`${alternate ? "md:flex-row" : "md:flex-row-reverse" } flex flex-col justify-between gap-8 items-center md:items-center md:px-12 lg:px-36  w-full mb-24`}>
            <div className='w-3/4 lg:w-1/2 relative'>
                ...
                <div className='w-full absolute bottom-0 backdrop-blur-md h-24 md:h-40 p-4 md:p-8'>
                    <p className='font-semibold font-primaryFont text-lg md:text-3xl text-left text-white md:mb-2'>{personName}</p>
                    <p className='font-semibold font-primaryFont text-sm md:text-xl text-left text-white md:mb-2'>{role}</p>
                    <p className='font-semibold font-primaryFont text-sm md:text-xl text-left text-white md:mb-2'>{location}</p>
                    <p></p>
                    <p></p>
                </div>
            </div>
