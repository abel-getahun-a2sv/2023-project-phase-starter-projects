        ...
        <div className="px-4 flex justify-center">
            <div className='grid grid-cols-1 md:grid-cols-2 mt-8 md:mt-40'>
                <div className='w-full xl:w-[400px] mr-14'>
                    <h1 className='font-primaryFont text-3xl md:text-[40px] font-bold text-[#2B2A35]'>The team we’re currently working with</h1>
                    <p className='font-secondaryFont mt-10 text-base md:text-xl leading-8'>Meet our development team is a small but highly skilled and experienced group of professionals. We have a talented mix of web developers, software engineers, project managers and quality assurance specialists who are passionate about developing exceptional products and services.</p>
...
const ProfileCard = ({name, occupation, description}: profile)=>{
    return(
        <div className="w-full h-auto pb-10 shadow-xl px-4 md:px-14 mt-20">
            ...
            <div>
                <h1 className="flex justify-center mt-4 font-primaryFont text-3xl tracking-widest font-bold">{name}</h1>
                <h2 className="flex w-full justify-center text-xl font-secondaryFont font-bold mt-2">{occupation}r</h2>
...
const Section2 = ()=>{
    return(
        <div className="px-4 md:px-20 grid md:gap-8 md:grid-cols-2 xl:grid-cols-3 w-full mb-20">
            <ProfileCard name="Nathaniel Awel" occupation="Software Engineer" description="He is a motivated software engineer looking to pursue a successful career in software development where he can help deliver software solutions to social problems. His skills include Web Development, Data Structures, Machine Learning, and DevOps. Natnael’s hobbies include coding, playing soccer, and watching movies." />
            <ProfileCard name="Nathaniel Awel" occupation="Software Engineer" description="He is a motivated software engineer looking to pursue a successful career in software development where he can help deliver software solutions to social problems. His skills include Web Development, Data Structures, Machine Learning, and DevOps. Natnael’s hobbies include coding, playing soccer, and watching movies." />
            <ProfileCard name="Nathaniel Awel" occupation="Software Engineer" description="He is a motivated software engineer looking to pursue a successful career in software development where he can help deliver software solutions to social problems. His skills include Web Development, Data Structures, Machine Learning, and DevOps. Natnael’s hobbies include coding, playing soccer, and watching movies." />
            <ProfileCard name="Nathaniel Awel" occupation="Software Engineer" description="He is a motivated software engineer looking to pursue a successful career in software development where he can help deliver software solutions to social problems. His skills include Web Development, Data Structures, Machine Learning, and DevOps. Natnael’s hobbies include coding, playing soccer, and watching movies." />
        </div>
